...
#### 技術棧
`.NET Core 2.0` `C#` `ASP.NET Web API` `SQL Server`

#### 主要職責
- 負責金融後台系統架構設計與技術規格文件撰寫
- 設計 RESTful API 介面規格，定義資料模型與業務邏輯層
- 第三方金流整合方案設計（支付通道、對帳、退款流程）
- 權限管理與稽核日誌系統設計

---

### 5. 颶風軟體企業系統 — 24 年持續演進的 .NET 平台
...
* 金融科技後台系統架構設計與 API 規格制定
* 技術棧：.NET Core 2.0, C#, ASP.NET Web API, SQL Server
* 負責第三方金流整合方案設計與權限管理系統
