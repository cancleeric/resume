...
window.DICT_ZH = {
  ...
  'og.description':      '把規格→設計→實作→審查→部署→維運整條流程自動化，自家集團 30+ 生產系統驗證。月費 US$ 10K，當週上工，可開發票。',
  'twitter.title':       '颶風軟體有限公司 — 開發流程自動化 · 20× 產出',
  'twitter.description': '一個人扛起整支團隊的產出 · 30+ 生產系統實戰 · 月費 US$ 10K · 當週上工',
  ...
  // ── meta-live banner ─────────────────────────────────────────────────────
  'metalive.head':       '這個頁面 <strong>100% 由 LLM 自主開發維護</strong>　·　無人手動改 code　·　每 30 分鐘自動跑一輪　·　您正在看的就是<strong>「開發流程自動化」實際運作中</strong>',
  ...
  'pricing.section.sub':   '合作流程：免費 30 分諮詢 → 報價簽約（30% 訂金）→ 開發 → 里程碑驗收 → 上線（含 1 個月保固）。付款：可開立統編發票（80289779）、支援電匯 / Wise / 加密貨幣 USDC。',
  ...
  'sys.claude-agents.tagline':'AI 高管副手角色庫 — 多角色虛擬團隊',
  ...
  'sys.claude-agents.metric': '技術／營運／商務／產品／資安／法務',
  ...
  // ── footer ────────────────────────────────────────────────────────────────
  'footer.copy':          '© 2026 颶風軟體有限公司 HurricaneSoft Ltd. · 統編 80289779 · 負責人 王英豪 · 台北市忠孝東路六段 79 號 2 樓 · v7.17 · 最後更新 2026/05/21 10:05',
