...
window.DICT_ZH = {
  ...
  'meta.description':    '颶風軟體有限公司（HurricaneSoft Ltd.）— 把整套開發流程自動化（規格→設計→實作→審查→部署→維運），一個人扛起以往需要整支團隊的產出。AI 整合是基本盤。月費 US$ 10,000、最快 1–2 週上工、可開發票（統編 80289779）。',
  ...
  // ── footer ────────────────────────────────────────────────────────────────
  'footer.copy':          '© 2026 颶風軟體有限公司 HurricaneSoft Ltd. · 統編 80289779 · 負責人 王英豪 · 台北市忠孝東路六段 79 號 2 樓 · v8.17 · 最後更新 2026/05/26 03:28',
