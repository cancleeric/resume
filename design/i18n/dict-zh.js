...
window.DICT_ZH = {
  ...
  'meta.description':    '颶風軟體有限公司（HurricaneSoft Ltd.）— 把整套開發流程自動化（規格→設計→實作→審查→部署→維運），一個人扛起以往需要整支團隊的產出。AI 整合是基本盤。月費 US$ 10,000；專案制 1–2 週起，可開發票（統編 80289779）。',
  'og.title':            '颶風軟體有限公司 · HurricaneSoft Ltd. — 開發流程自動化接案 · 一年交付 14+ 產品',
  'og.description':      '把規格→設計→實作→審查→部署→維運整條流程自動化，自家集團 30+ 生產系統驗證。月費 US$ 10K；專案制 1–2 週起，可開發票。',
  'twitter.title':       '颶風軟體有限公司 · HurricaneSoft Ltd. — 開發流程自動化接案 · 一年交付 14+ 產品',
  'twitter.description': '一個人扛起整支團隊的產出 · 30+ 生產系統實戰 · 月費 US$ 10K · 專案制 1–2 週起',
  ...
  'why.freelancer.row.02': '時薪看似低，但 scope 蔓延 + 重工成本高，實際付費往往超標',
  ...
  'pricing.section.sub':   '合作流程：免費 30 分諮詢 → 報價簽約（30% 訂金）→ 開發 → 里程碑驗收 → 上線（含 1 個月保固）。付款：可開立統編發票（80289779）、支援電匯 / Wise / 加密貨幣 USDC。交付保障：**每個里程碑驗收完即移交當下完整版本**，code、文件、CI/CD、密鑰規範全到位——主控權始終在您手上，不需等到結案才能拿走。',
  ...
  'faq.03.a': '月費模式讓負責人 + AI 副手團隊全力投入，不必為了計時打折注意力。\n\n重點不在「時數」，在**產出密度**——自家工具鏈讓單月產出等價傳統做法 2–3 個月進度（實證：SaaS 0→生產最快 23 天）。\n\n同等 hourly 預算（約 US$ 80/h × 125h）只買到一個工程師的單層交付；月費買的是整條 pipeline 全覆蓋：spec→設計→開發→審查→部署→維運。',
  ...
  'faq.06.a': '專案制 / 月費結束後，code、文件、CI/CD 設定、密鑰管理規範全交付給您；不需等到結案——**每個里程碑驗收完即可拿走當下完整版本**，隨時可帶走給任何團隊接手。自家通用工具（Brain LLM Gateway 等）可授權使用，不另收授權費。',
  ...
  // ── footer ────────────────────────────────────────────────────────────────
  'footer.copy':          '© 2026 颶風軟體有限公司 HurricaneSoft Ltd. · 統編 80289779 · 負責人 王英豪 · 台北市忠孝東路六段 79 號 2 樓 · v8.74 · 最後更新 2026/05/26 16:30',
