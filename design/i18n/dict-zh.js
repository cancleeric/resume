...
window.DICT_ZH = {
  ...
  'faq.01.q': '檔期多久能排到？',
  'faq.01.a': '顧問諮詢類隨到隨接（4 小時起）。月費 Retainer 同時段最多 2 案，下個檔期 2026/07 起（約 6 週後）。專案制依範圍 1-2 週內可 kick-off。',
  'faq.02.q': '會簽 NDA / 開發票嗎？',
  'faq.02.a': '會。可開立公司行號統編發票（80289779），標準 NDA 模板可立即簽署，客製 NDA 24 小時內回覆。付款支援電匯／Wise／加密貨幣（USDC）。',
