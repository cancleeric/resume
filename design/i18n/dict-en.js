...
window.DICT_EN = {
  ...
  'og.description':      'Full pipeline automation (spec → build → deploy → ops). SaaS from 0 to production in 23 days. 30+ production systems validated. Monthly retainer US$10K; project engagements from 1–2 weeks. Invoice available.',
  'twitter.title':       'HurricaneSoft Ltd. — Automated Software Delivery · 14+ Products in a Year',
  'twitter.description': 'One engineer, full team output · SaaS 0→prod in 23 days · 30+ production systems · US$10K/month',
  ...
  'hero.sub':            'AI integration is table stakes — the real differentiator is <b style="color:var(--text-hi)">automating the entire delivery pipeline</b>: spec → design → build → review → deploy → ops, with AI copilots owning every stage.',
  ...
  'trust.item.04.name':  'public client cases',
  ...
  'systems.section.title':    'From Shared Platform to Vertical SaaS —<br/>Not a Collection of Unrelated Demos.',
  'systems.section.sub':      'Identity, payments, AI capabilities, and GCP Cloud Run infrastructure are shared; each product stays focused on its business domain. The systems below cover AI development, enterprise automation, IAM, and production SaaS with real delivery records.',
  'systems.tab.ai.label':     'AI / Agent Products',
  'systems.tab.saas.label':   'External SaaS',
  'systems.tab.infra.label':  'HurricaneSoft Platform',
  // taglines [R] from I18N item-* keys (condensed)
  'sys.lobsterfarm.tagline':  'AI workforce management — scheduling, task assignment, access, cost, and performance in one platform',
  'sys.squid.tagline':        'HurricaneSoft project and ticket SaaS — foundation for AI Agent ticket-driven development',
  'sys.openclaw.tagline':     'Enterprise digital worker — automates email, messaging, reporting, scheduling, and document filing',
  ...
  'sys.brain.tagline':        'HurricaneSoft AI Agent Platform',
  ...
  'sys.anemone.tagline':      'HurricaneSoft AI API Gateway — relay / LLM ingress',
  'sys.aegis.tagline':        'Autonomous AI security agent — vulnerability scanning and release gates built into delivery',
  ...
  'sys.gyre.tagline':         'Cross-platform social publishing SaaS v0.11.0 — write once, sync everywhere',
  'sys.nautilus.tagline':     'Cloud enterprise identity — SSO / SAML / OIDC / MFA / RBAC',
  'sys.localids.tagline':     'On-prem enterprise identity for controlled, auditable environments',
  'sys.hurricane-pay.tagline':'HurricaneSoft Unified Payment Microservice v0.13.0',
  ...
  'sys.headscale.tagline':    'HurricaneSoft Internal VPN',

  // sys metric keys
  'sys.lobsterfarm.metric':   'Multi-model dispatch + cost / KPI dashboards',
  'sys.squid.metric':         'Multi-tenant + strict state machine',
  'sys.openclaw.metric':      'Ready-to-deploy enterprise automation',
  ...
  'sys.aegis.metric':         'Automated pre-release security checks',
  'sys.nautilus.metric':      'Zero trust + fine-grained access + audit',
  ...
  'sys.tentacle.metric':      'Shared across products',
  ...
  'timeline.section.sub':     'Systems delivered by HurricaneSoft — in-house SaaS, shared platform infrastructure, and enterprise client projects. No stock photos, no "concept illustrations".',
  ...
  'timeline.kind.infra':      'HurricaneSoft Platform',
  ...
  'timeline.item.02.title':   'Hurricane Pay — HurricaneSoft Payment Service',
  ...
  'timeline.item.07.title':   'STA Swimming & Lifesaving Association — Legacy Modernization',
  'timeline.item.07.summary': 'Modernized a system left untouched for over a decade, upgrading PHP 5.6→7 and CodeIgniter 1→3; registration, administration, and training management are live in production.',
  ...
  'timeline.item.09.title':   'Independent Nail Studio — Booking & Work-Order System',
  'timeline.item.09.summary': 'Digitized appointments and nail-service work orders through the automated delivery pipeline; a one-person studio now operates and maintains its own production system.',

  // ── tech stack ────────────────────────────────────────────────────────────
  'tech.section.title':       'Tech Stack · Used, shipped, and running.',
  'tech.section.sub':         'Cross-language and cross-platform engineering is the core capability. The technologies below are representative, not a ceiling; choices follow the product, team, and existing system.',
  'tech.profile.aria':        'Technical breadth and education',
  'tech.profile.languages':   'Programming-language experience across approximately 60 languages',
  'tech.profile.top25':       'Production experience in at least 13 of 2026\'s top 25 mainstream languages',
  'tech.profile.experience':  'Hands-on software engineering',
  'tech.profile.education':   'Bachelor\'s degree',
  'tech.lang.java.badge':     'production experience · less recent',
  // [R] from I18N stack-*
  'tech.cat.lang':            'Representative languages',
