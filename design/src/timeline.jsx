...
function Timeline() {
  ...
  const items = [
    ...
    },
    {
      ...
      version: '—',
      title: '中小企業信用保證基金 — 技術顧問',
      tag: 'enterprise',
      summary: '主導舊系統從 .NET Framework 4.6 升級至 .NET 8 + Blazor，採微服務架構；跨年度 8 人外部技術團隊交付；支援台灣銀行端信用保證業務之核心生產系統。',
      kind: '企業客戶',
    ...
    },
    {
      ...
      title: 'STA 組織綜合管理平台',
      tag: 'enterprise',
      summary: '中華民國游泳救生協會線上課程報名系統，服務 5,000+ 學員，線上報名率 +80%、行政時間 -60%；PHP CodeIgniter HMVC + 15+ 種營運報表；2026 持續維運。',
      kind: '企業客戶',
    ...
    },
    {
      ...
      version: '—',
      title: 'LifeSnap — iOS 多功能社交遊戲',
      tag: 'enterprise',
      summary: '多米諾骨牌對戰手遊，SwiftUI + SpriteKit + Firebase + CloudKit；即時多人對戰、ChatGPT AI 聊天、AdMob 廣告；已上 App Store。',
      kind: '企業客戶',
