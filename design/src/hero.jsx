          ...
          <div className="reveal">
            ...
            {window.LANG === 'en' ? (
              <p className="hero-sub">
                Hands-on generative AI and LLM engineering since 2022. AI is embedded across the <b style={{ color: 'var(--text-hi)' }}>entire development pipeline</b> —
              ...
              <p className="hero-sub">
                自 2022 年起投入生成式 AI／LLM 實務。颶風軟體已把 AI 深度導入<b style={{ color: 'var(--text-hi)' }}>整套開發與營運流程</b>——
                <span className="stage">SPEC</span> → <span className="stage">DESIGN</span> → <span className="stage">BUILD</span> → <span className="stage">REVIEW</span> → <span className="stage">DEPLOY</span> → <span className="stage">OPS</span>
            ...
            {window.LANG === 'en' ? (
              <p className="hero-claim">
                AI-native delivery proof: <b>14+ AI-assisted products and 30+ production systems, with SaaS shipped in as little as 23 days (214 commits — verifiable in git)</b>. Digital employees support research, specification, implementation, testing, review, deployment, and operations.
              </p>
            ) : (
              <p className="hero-claim">
                AI 原生工程實績：<b>以 AI 協作開發 14+ 個產品、維運 30+ 個生產系統，SaaS 0→生產最快 23 天（214 commits，git 紀錄可查）</b>。數位員工分工支援研究、規格、開發、測試、審查、部署與營運。
              </p>
            )}
            ...
            <div className="kpi-band">
              ...
              <div className="kpi">
                <div className="value">2022<span className="plus">→</span></div>
                <div className="label">{t('hero.kpi.04.label')} <span className="en">SINCE 2022</span></div>
              </div>
            </div>
