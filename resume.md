...
設計並實施兩層式 CI/CD 架構（Git Hooks post-commit 本地建置 + pre-push Staging 部署），管理從本地 Docker 開發到 GCP Cloud Run 生產環境的完整 DevOps Pipeline。現管理 **11 人跨職能工程團隊**，建立工單驅動的標準化開發流程與自動化評審系統。
...
* 管理 **11 人跨職能團隊**（開發、DBA、DevOps、部署、助理）
...
**角色**：技術架構師 / 技術負責人 | 主導 11 人團隊 | 2024/11 - 至今
...
* 管理 **11 人跨職能技術團隊**，負責員工技術培訓與 Code Review
...
* **內部後台**：供數十位美編設計師使用的 POP 模板管理系統（製作 / 圖庫維護 / 訂單追蹤）
* **技術演進**：ASP / Java / C++ 第一代 → Apache / PHP / MySQL 重構（當時業界前沿的 LAMP Stack）
